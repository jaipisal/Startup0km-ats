...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center px-4 bg-background">
      ...
      >
        <div className="rounded-3xl glass-strong glass-border shadow-xl p-8">
          <div className="text-center mb-8 flex flex-col items-center">
            <Logo size="lg" />
            <h1 className="font-display text-2xl font-bold text-foreground mt-6 mb-2">Welcome back</h1>
